...
class ParallelMinGRU(nn.Module):
    ...
    def forward(self, x):
        ...
        h = parallel_scan_log(log_one_minus_z, log_z + log_tilde_h, dim=1)
        """
        Note: Currently, I am working under the assumption that
        we return the h[1:t], because we will need all h[i] for 
        the subsequent layer. TODO: Verify this assumption.
        """
