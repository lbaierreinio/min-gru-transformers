            ...
            if not self.bidirectional: # Non bidirectional
                ...
                for t in range(seq_len):
                    ...
                    for layer_idx, layer in enumerate(self.layers):
                        ...
                        output, h_prev_forward[layer_idx], h_prev_backward[layer_idx] = layer((x_l_forward, x_l_backward), mask=(mask_forward_t, mask_backward_t), h_prev=(h_prev_forward_l, h_prev_backward_l))
